...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
        <h1 className='text-3xl font-medium'>Find by vibe</h1>
        <p className='sm:w-1/3 text-center text-sm'>Simply browse through our extensive list of workshop, schedule your appointment hassle-free.</p>
